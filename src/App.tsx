...
import Onboarding1 from './Screens/E-learningOnboarding/Onboarding1';
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Stack.Screen
          name="DesignUiMainIntro"
          component={designUiIntroScreen}
        />
        <Stack.Screen
          name="DesignUiMainContactUs"
          component={designUiContactUs}
        />
        <Stack.Screen name="DesignUiMainHome" component={designUiHomeScreen} />
        <Stack.Screen
          name="DesignUiMainPayment"
          component={DesignStudioPayment}
        />
        <Stack.Screen
          name="OnboardingUiIntroduction"
          component={OnboardingUiIntroduction}
        />
        <Stack.Screen
          name="OnboardingUiHome"
          component={onboardingScreenUiHome}
        />
        <Stack.Screen name="learningOnboarding1" component={Onboarding1} />
      </Stack.Navigator>
    </NavigationContainer>
  );
};
